...
# Implementación sin bibliotecas externas para calcular el MSE
...
print(f"MSE Sin Regularización: {mse_no_reg}")
print(f"MSE Regularización L1 (Lasso): {mse_l1}")
print(f"MSE Regularización L2 (Ridge): {mse_l2}")
